...
const text = [ 'This is the first paragraph. It appears with a typing effect.',
...
const GearsAnimation: React.FC = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            setIsRotating(window.scrollY > 50); // Анимация запускается при скролле более чем на 50 пикселей
        };
    ...
    return (
        <div className="gears-container" style={{height:'200vh'}} >
            <svg fill="#000000" version="1.1" id="gear"  className={`gear large-gear ${isRotating ? 'rotate-large' : ''}`}
                 width="200px" height="200px" viewBox="0 0 45.973 45.973"
                 >
                <g>
                    <g>
            ...
            <span style={{height:'600px',width: '600px', border: '2px solid ', rotate: 'y 88deg'}}
                  className={`list ${isRotating ? 'up-list' : ''}`} >
                <TypingText paragraphs={text}  />
            </span>

            <svg fill="#000000" version="1.1" id="gear"  className={`gear small-gear ${isRotating ? 'rotate-small' : ''}`}
                 width="200px" height="200px" viewBox="0 0 45.973 45.973"
            >
                <g>
                    <g>
